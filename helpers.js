...
const processData = function (data, timePortion) {
    ...
    return new Promise(function (resolve) {
        ...
        console.log('Feature Selection (Close Price):', features);

        // Scale the values
        let scaledData = minMaxScaler(features, getMin(features), getMax(features));
        let scaledFeatures = scaledData.data;

        console.log('Scaled Data:', scaledFeatures);
