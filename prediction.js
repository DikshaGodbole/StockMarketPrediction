    ...
    return new Promise(function (resolve, reject) {
        try {
            ...
            model.fit(data.tensorTrainX, data.tensorTrainY, {
                ...
                print("<html><head> <link rel=\"stylesheet\" href=\"css/style.css\" /><link href=\"//maxcdn.bootstrapcdn.com/bootstrap/3.3.0/css/bootstrap.min.css\" rel=\"stylesheet\" id=\"bootstrap-css\">\n" +
                    "<script src=\"//maxcdn.bootstrapcdn.com/bootstrap/3.3.0/js/bootstrap.min.js\"></script>\n" +
                    "<script src=\"//code.jquery.com/jquery-1.11.1.min.js\"></script></head><body><div class='well well-1'>Loss after last Epoch (" + result.epoch.length + ") is: " + result.history.loss[result.epoch.length-1]+"</div></body></html>");
                resolve(model);
            })
        }
        catch (ex) {
...
$(document).ready(function () {
    ...
    $('#getCompany').click(function () {
        ...
        print("<html><head> <link rel=\"stylesheet\" href=\"css/style.css\" /><link href=\"//maxcdn.bootstrapcdn.com/bootstrap/3.3.0/css/bootstrap.min.css\" rel=\"stylesheet\" id=\"bootstrap-css\">\n" +
            "<script src=\"//maxcdn.bootstrapcdn.com/bootstrap/3.3.0/js/bootstrap.min.js\"></script>\n" +
            "<script src=\"//code.jquery.com/jquery-1.11.1.min.js\"></script></head><body><div class='well well-1'>Predicting.....</div></body></html>");
        ...
        $.getJSON(url.replace('%company%', company).toLowerCase()).then(function (data) {
            ...
            processData(data, timePortion).then(function (result) {
                ...
                console.log('For next day', predictDate,'prediction:', nextDayPrediction);
                ...
                buildCnn(result).then(function (built) {
                    ...
                    cnn(built.model, tensorData, epochs).then(function (model) {
                        ...
                        let predictedX = model.predict(tensorData.tensorTrainX);
                        ...
                        predictedValue.data().then(function (predValue) {
                            ...
                            console.log('Predicted:', inversePredictedValue.data[0]);
                            ...
                            predictedX.data().then(function (pred) {
                                ...
                                let trainYInverse = minMaxInverseScaler(built.data.trainY, min, max);
                            ...
                            print("<html><head> <link rel=\"stylesheet\" href=\"css/style.css\" /><link href=\"//maxcdn.bootstrapcdn.com/bootstrap/3.3.0/css/bootstrap.min.css\" rel=\"stylesheet\" id=\"bootstrap-css\">\n" +
                                "<script src=\"//maxcdn.bootstrapcdn.com/bootstrap/3.3.0/js/bootstrap.min.js\"></script>\n" +
                                "<script src=\"//code.jquery.com/jquery-1.11.1.min.js\"></script></head><body><div class='well well-1'>Predicted Stock Price of " + company + " for date " + moment(predictDate).format("DD-MM-YYYY") + " is: " + "<b>$" + inversePredictedValue.data[0].toFixed(3)+"</b></div></body></html>");
                        });
